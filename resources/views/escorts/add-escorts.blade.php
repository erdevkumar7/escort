                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <select class="form-control" id="hair_color" name="hair_color">
                                            ...
                                            <option value="Brunette"
                                                {{ old('hair_color') == 'Brunette' ? 'selected' : '' }}>Brunette</option>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <select class="form-control" id="language_spoken" name="language_spoken[]"
                                            ...
                                            <option value="Chinese"
                                                ...
                                                Chinese</option>
                                            <option value="Other"
                                                {{ in_array('Other', old('language_spoken', [])) ? 'selected' : '' }}>Other
                                            </option>
                                        </select>
                                    </div>
                                    {{-- services --}}
