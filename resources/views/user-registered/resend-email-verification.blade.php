    ...
    <div class="form-login forgot-escort-form" id="forgot-escort-form-id">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" action="{{route('user.verification.resend')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <p class="text-center text-muted mt-3 mb-0"> <a
                            href="{{route('user.login.form')}}" class="fw-bold text-body"><u class="agency-login-back">Back To Login</u></a></p>
                    </div>
                </form>
