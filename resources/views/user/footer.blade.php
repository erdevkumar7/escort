<section class="disclaimer">
    <div class="disclaimer-inner-text text-white">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
            ...
            anim id est laborum. nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
            aute irure dolor in reprehenderit in
    ...
    <div class="stay-upto-date">
        <div class="stay-upto-left">
            <h2 class="text-white">STAY UPTO DATE ABOUT OUR LATEST OFFERS</h2>
        </div>

        <div class="stay-upto-right">
            <form>
                <div class="form-group">
                    <img src="{{asset('/public/images/static_img/inbox.png')}}">
                    <input type="email" class="form-control" id="InputEmail1"
                        placeholder="Enter your email address">
                </div>
                <a href="#"><button>Subscribe to Newsletter</button></a>
            </form>
        </div>
    </div>
