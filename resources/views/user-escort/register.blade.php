...
@section('auth_content')
   ...
   <div class="container-login100">
      <div class="wrap-login100">
         <form class="login100-form validate-form" action="{{ route('escorts.register_submit') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <!--         <div class="flex-sb-m w-full p-t-3 p-b-32">
         ...
         <div class="login100-more" style="background-image: url('https://votivelaravel.in/escorts/public/images/static_img/loginform-pic.jpg');"></div>
      </div>
   </div>
</div>
