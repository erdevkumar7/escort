    ...
    <div class="form-login forgot-agency-form" id="forgot-agency-form-id">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" action="{{ route('user.password.email') }}" method="POST"
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <p class="text-center text-muted mt-3 mb-0"> <a href="{{ route('user.login.form') }}"
                                class="fw-bold text-body"><u class="agency-login-back">Back To Login</u></a></p>
                    </div>
                </form>
